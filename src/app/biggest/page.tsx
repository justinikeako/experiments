export default function Page() {
  return (
    <main className="group flex h-full touch-none select-none items-center justify-center overflow-hidden perspective-400">
      <h1 className="md:8xl relative flex -translate-y-[.25em] translate-x-[.5em] transform items-center justify-start text-6xl transition-transform duration-1000 -rotate-x-30 rotate-y-45 group-active:-translate-x-[.5em] group-active:-translate-y-0 group-active:-rotate-y-30 group-active:rotate-x-30 group-active:rotate-z-12 group-active:translate-z-32 sm:text-7xl sm:group-active:-translate-x-[.75em] md:text-8xl lg:text-9xl lg:group-active:-translate-x-[1em]">
